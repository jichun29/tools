...
def get_quarter_end_date():
    ...
    # 计算下个季度的第一天，修正月份值使其在1到12之间
    next_quarter_first_day_month = ((current_month - 1) // 3 + 1) * 3 + 1
    if next_quarter_first_day_month > 12:
        next_quarter_first_day_month = 1
        current_year += 1
    next_quarter_first_day = datetime(current_year, next_quarter_first_day_month, 1)
    # 计算当前季度的最后一天
