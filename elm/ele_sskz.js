...
async function _0x435ec7(_0x2c858d, _0x2332d1, _0x4b59f3, _0x5aa3cc) {
    ...
    _0x52d858 && _0x52d858.data.rlist && console.log("       ");
}
async function _0x5c575e(_0x51b2b, _0x3d9812, _0x5953dd) {
    ...
    _0x3eaff1 && _0x3eaff1.rlist && console.log("       ");
}
    ...
    return _0x358f23(_0x389653 => {
        _0x34af9d(_0x1d7429, async (_0x4e0866, _0x431add, _0x2832ce) => {
            if (!_0x4e0866 && _0x431add.statusCode === 200) {
                ...
                _0x4e0866 && (_0x4e0866.message.indexOf("socket hang up") !== -1 || _0x4e0866.message.indexOf("read ECONNRESET") !== -1) ? (console.log("        ʧ ܣ      2        "), await _0x1e0e6b(2), _0x389653(await _0x1986db(_0x3eb1c, _0x5db2f7, _0x131052 - 1))) : (console.log("     쳣          ״  "), _0x389653(""));
            }
        });
    });
};
    ...
    for (let _0x1c70c2 = 0; _0x1c70c2 < _0x5f9ed.length; _0x1c70c2++) {
        ...
        while (true) {
            ...
            if (_0x2f18c9.errcode == 0) {
                console.log("  ȡ  ҳɹ     ǰ  ң " + _0x2f18c9.value);
